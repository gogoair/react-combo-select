...
var DropDownIcon = function DropDownIcon(props) {
	return _react2.default.createElement(
		_index2.default,
		_extends({}, props, { className: 'SvgIconDropDownIcon' }),
...
var _temp = function () {
	...
	__REACT_HOT_LOADER__.register(DropDownIcon, 'DropDownIcon', 'src/Components/svg/DropDownIcon.jsx');

	__REACT_HOT_LOADER__.register(_default, 'default', 'src/Components/svg/DropDownIcon.jsx');
}();
